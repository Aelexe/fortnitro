	...
	return (function(t) {
			...
			var l = (function() {
				function t(e, n) {
					i(this, t),
						...
						(this.recalculate = (0, a.default)(this.recalculate, 100, { leading: !0 })),
						this.init();
				}
				return (
					s(
						...
						[
							{
								...
								value: function() {
									(this.el.SimpleBar = this),
										...
										(this.scrollContentEl.style[this.isRtl ? "paddingLeft" : "paddingRight"] = "".concat(
										...
										0 !== this.scrollbarWidth &&
											(this.contentEl.style[this.isRtl ? "marginLeft" : "marginRight"] = "-".concat(
												this.scrollbarWidth,
												"px"
											)),
										this.recalculate(),
							...
							},
							{
								...
								value: function() {
									var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "y";
									this.isVisible[t] &&
										("x" === t ? this.scrollbarX.classList.add("visible") : this.scrollbarY.classList.add("visible"),
							...
							},
							{
								...
								value: function() {
									(this.contentSizeX = this.contentEl[this.scrollSizeAttr.x]),
										(this.contentSizeY =
											this.contentEl[this.scrollSizeAttr.y] - (this.scrollbarWidth || this.offsetSize)),
										(this.scrollbarXSize = this.trackX[this.sizeAttr.x]),
										(this.scrollbarYSize = this.trackY[this.sizeAttr.y]),
										this.resizeScrollbar("x"),
										this.resizeScrollbar("y"),
										this.options.autoHide || (this.showScrollbar("x"), this.showScrollbar("y"));
								}
							},
							{
				...
				return function(e, n) {
					...
					return a < 0 || a >= u
						? t
							...
							: void 0
						: ((o = c.charCodeAt(a)),
						  o < 55296 || o > 56319 || a + 1 === u || (s = c.charCodeAt(a + 1)) < 56320 || s > 57343
								? t
									? c.charAt(a)
									: o
								: t
		...
		function(t, e, n) {
			...
			t.exports = function(t, e, n, v, b, y, m) {
				...
				if (
					(L && (O = f(L.call(new t()))) !== Object.prototype && O.next && (l(O, x, !0), r || c(O, h) || s(O, h, p)),
					w &&
						k &&
						"values" !== k.name &&
						((S = !0),
		...
		function(t, e, n) {
			...
			t.exports =
				...
				function(t, e) {
					var n;
					return (
						null !== t ? ((c.prototype = r(t)), (n = new c()), (c.prototype = null), (n[s] = t)) : (n = a()),
						void 0 === e ? n : i(n, e)
					);
				};
		},
